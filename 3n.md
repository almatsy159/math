...
#note : r * 3 + k = n
 ...
 ## forme du nombre
 n = (x;y) = (x/2;y;x/2)  : n = Somme composantes ex 31 = 16+15
 x/2,y est N 
 si y= 2x : n est 4 fois divisible
 

 ## comportement
n1 = n0 + Somme(i[0:k];2**i * 3**(k-i))

 pour 2**n - 1 : (31,7,15) => 16 = 2**n 
 31 + 16 + 
 31 + 2*2*2*2 + 2*2*2*3 + 2*2*3*3 + 2*3*3*3 + 3*3*3*3 = 242 => -121=> 121 
